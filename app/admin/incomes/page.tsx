                ...
                <div className="relative z-10 flex flex-col lg:flex-row items-center gap-6">
                    ...
                    <div className="flex flex-wrap items-center gap-4 w-full lg:w-auto">
                        <select
                            ...
                            className="flex-1 lg:flex-none bg-background-main/50 border border-border-main rounded-xl px-4 py-3.5 text-[10px] font-black uppercase tracking-widest text-text-primary outline-none cursor-pointer hover:border-emerald-500/30 transition-all appearance-none min-w-[140px]"
                        >
