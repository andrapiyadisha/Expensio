    ...
    const fetchSummary = async () => {
        try {
            ...
            setSummary({
                ...
                thisMonthExpense: data.thisMonthExpense,
    ...
    return (
        <div className="space-y-8 animate-in fade-in duration-700">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
                ...
                <StatCard
                    title="This Month"
                    value={`₹${summary.thisMonthExpense.toLocaleString()}`}
                    ...
                    <div className="flex flex-wrap items-center gap-4 w-full lg:w-auto">
                        <div className="flex-1 lg:flex-none relative h-full">
                            <select
                                ...
                                className="w-full bg-background-main/50 border border-border-main rounded-xl px-4 pr-10 py-3.5 text-[10px] font-black uppercase tracking-widest text-text-primary outline-none cursor-pointer hover:border-blue-500/30 transition-all appearance-none min-w-[140px]"
                            >
                                ...
                                <div className="space-y-4">
                                    ...
                                    <div className="flex justify-between items-end pt-4 border-t border-border-main/50">
                                        <div>
                                            ...
                                            <p className="text-lg font-black text-text-primary tracking-tighter">₹{parseFloat(exp.Amount).toLocaleString()}</p>
                                        </div>
