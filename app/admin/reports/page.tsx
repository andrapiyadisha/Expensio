        ...
        <div className="space-y-8 animate-in fade-in duration-700">
            ...
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
                ...
                <div className="flex gap-3 w-full md:w-auto">
                    <button className="flex-1 md:flex-none flex items-center justify-center gap-2 bg-background-card border border-border-main text-text-primary px-5 py-3 rounded-xl text-[10px] font-black uppercase tracking-widest hover:bg-background-main transition-all group">
                        <Download size={14} className="group-hover:translate-y-0.5 transition-transform" />
                        PDF Report
                    </button>
                    <button className="flex-1 md:flex-none flex items-center justify-center gap-2 bg-blue-600 text-white px-6 py-3 rounded-xl text-[10px] font-black uppercase tracking-widest shadow-lg shadow-blue-500/20 hover:scale-[1.02] active:scale-95 transition-all">
                        <FileText size={16} />
                        Export Excel
                    </button>
                </div>
                    ...
                    <table className="w-full text-left border-collapse">
                        <thead>
                            <tr className="bg-background-main/80 border-b border-border-main">
                                <th className="px-8 py-5 text-[10px] font-black uppercase tracking-[0.2em] text-muted">Project Identification</th>
                                        ...
                                        <tr key={proj.ProjectID} className="hover:bg-background-main/50 transition-all group/row">
                                            ...
                                            <td className="px-8 py-6 text-right">
                                                <span className="text-[11px] font-black text-rose-400 tabular-nums">
                                                    â‚¹{parseFloat(proj.Spent).toLocaleString()}
                                                </span>
                                            </td>
                                            <td className="px-8 py-6 text-right">
            ...
            <div className="p-8 bg-blue-600/5 border border-blue-500/20 rounded-2xl flex flex-col md:flex-row items-center justify-between gap-6">
                ...
                <button className="w-full md:w-auto px-8 py-3 bg-blue-600 hover:bg-blue-500 text-white text-[10px] font-black uppercase tracking-widest rounded-xl transition-all shadow-lg shadow-blue-500/20 active:scale-95">
